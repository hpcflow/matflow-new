...
Physical Surface("y-mid-plane") = { Surface In BoundingBox{0.0-tol, 0.0-tol, 0.0-tol_thick,
                                                          plate_width/2+tol, 0.0+tol, plate_thick+tol_thick} };

Physical Surface("y-top-plane") = { Surface In BoundingBox{0.0-tol, plate_height/2-tol, 0.0-tol_thick,
                                                          plate_width/2+tol, plate_height/2+tol, plate_thick+tol_thick} };

Physical Surface("x-mid-plane") = { Surface In BoundingBox{0.0-tol, 0.0-tol, 0.0-tol_thick,
                                                          0.0+tol, plate_height/2+tol, plate_thick+tol_thick} };

Physical Surface("z-base-plane") = { Surface In BoundingBox{0.0-tol, 0.0-tol, 0.0-tol_thick,
                                                           plate_width/2+tol, plate_height/2+tol, 0.0+tol_thick} };
